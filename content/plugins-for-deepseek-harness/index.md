---
title: 给 DeepSeek Harness 写了两个插件
date: 2026-08-21
tags: AI / AGENT / TOOLS
...
![中间过程折叠收起](dsh-folded-collapse.png)
![中间过程展开浏览](dsh-folded-expand.png)
...
![左轨 Query 导航器交互演示](dsh-plugins-demo.mp4)

做这两个插件，大概花了 10 多块钱的 API 费用（消耗约 1.6 亿 Tokens）：

![DeepSeek API 账单](dsh-api-bill.png)
